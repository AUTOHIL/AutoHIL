"""Ablation: without api knowledge base"""
import os
import sys
...
from reqDec_wo_rag import requirement_breakdown
                ...
                for i, item in enumerate(target_data):
                    ...
                    if augmented_req:
                        ...
                        try:
                            ...
                            decomposed_req = requirement_breakdown(req_id, augmented_req, KNOWLEDGE_FILES)
                        except Exception as e:
