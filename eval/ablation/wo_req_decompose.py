"""Ablation: without req decomposition"""
# preparation: 
            ...
            if target_data:
                for i, item in enumerate(target_data):
                    ...
                    if augmented_req:
                        ...
                        try:
                            bt_json, json_file = bt_encoder(augmented_req, module_name, req_id)
                        except Exception as e:
                    ...
                    # -------------- Post Processing --------------
                    if augmented_req and bt_json and generated_code:
                    ...
                    if augmented_req and bt_json and generated_code and refined_code:
...
if __name__ == "__main__":
    # Load configuration from project config.json (two levels up)
